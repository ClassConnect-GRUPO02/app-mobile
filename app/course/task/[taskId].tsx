...
export default function TaskDetailScreen() {
    ...
    const fetchTaskAndUserStatus = async () => {
      try {
        ...
        if (!isInstructor) {
          ...
          try {
            const submissionData = await taskClient.getTaskSubmission(
              taskId,
              currentUserId
            );
  ...
  const renderSubmissionStatus = () => {
    ...
    const isExamBeforeDue = task.type === "examen" && now < dueDate;
    ...
    return (
      <View style={styles.submissionStatus}>
        ...
        {isExamBeforeDue && (
          <Text style={{ marginTop: 12, fontStyle: "italic", color: "#888" }}>
            Podrás ver tu calificación y retroalimentación después de la fecha
            límite del examen.
          </Text>
        )}
      </View>
          ...
          <View style={styles.taskInfo}>
            ...
            <Chip
              style={[
                ...
                {
                  backgroundColor:
                    task.type === "tarea" ? "#e3f2fd" : "#fff3e0",
                },
              ]}
              textStyle={{
                color: task.type === "tarea" ? "#1976d2" : "#e65100",
              }}
            >
